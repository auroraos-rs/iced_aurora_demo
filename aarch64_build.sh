...
cp ./target/aarch64-unknown-linux-gnu/release/iced_aurora ./com.lmaxyz.IcedAurora

$SFDK_PATH config target="AuroraOS-5.1.3.85-MB2-aarch64"

$SFDK_PATH build
$SFDK_PATH engine exec -tt sb2 -t 'AuroraOS-5.1.3.85-MB2-aarch64' rpmsign-external sign -k $CURRENT_DIR/../.auroraos-regular-keys/regular_key.pem -c $CURRENT_DIR/../.auroraos-regular-keys/regular_cert.pem $CURRENT_DIR/RPMS/com.lmaxyz.IcedAurora-0.1-1.aarch64.rpm
